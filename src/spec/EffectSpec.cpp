...
EffectSpec::EffectSpec(Cube *cube)
        : cube(cube) {
}
...
void EffectSpec::shiftingTextSpec() {
    unsigned char fontStream[] = { 0x0, 0x5, 0x8, 0x2, 0x48, 0x48, 0x0, 0xc, 0x50, 0x50, 0x0, 0x11, 0x7f, 0x8, 0x8, 0x8, 0x7f, 0x7f, 0x9, 0x9,
            0x9, 0x6 };
    ByteArrayInputStream is = ByteArrayInputStream(&fontStream[0], (unsigned int) sizeof(fontStream));
    BitmapFont font = BitmapFont((SeekableInputStream*) &is);
